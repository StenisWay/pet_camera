...
狀態碼對應依 rule_doc/功能需求/10_錯誤處理與狀態規範.md 第 3 節與
06_spec_即時串流.md 第 7 節。兩處與通用預設不同的地方:

1. BusinessRuleViolation -> 400(不是 422):規格書明定 VAL_001 是 400。
2. Timeout -> 408:STREAM_005 是其餘六個服務都沒有用到的狀態碼。
"""
...
STATUS_BY_CATEGORY: dict[type[DomainError], int] = {
    NotFound: 404,
    Conflict: 409,  # STREAM_001 裝置離線
    PermissionDenied: 403,
    BusinessRuleViolation: 400,  # VAL_001,見 10_錯誤處理與狀態規範.md 第 3 節
    AuthenticationRequired: 401,  # AUTH_001 / AUTH_002 / STREAM_002
    Timeout: 408,  # STREAM_005 signaling 逾時
